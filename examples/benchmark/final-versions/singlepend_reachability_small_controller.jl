...
all_sets, all_sets_symbolic = symbolic_reachability_with_concretization(query, input_set, [20, 20])
t2 = Dates.time()
dt = (t2-t1)
print("elapsed time= $(dt) seconds")

using JLD2
JLD2.@save "examples/benchmark/single_pendulum_reachability_small_controller_data.jld2" query input_set all_sets all_sets_symbolic dt

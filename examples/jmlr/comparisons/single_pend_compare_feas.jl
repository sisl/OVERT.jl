...
# x1 <= -0.2167 is the avoid set
avoid_set = HalfSpace([1.0, 0.0], -0.2167)
...
using JLD2
JLD2.@save "examples/jmlr/data/comparison_single_pendulum_satisfiability_$(controller_type)_controller_data.jld2" query input_set avoid_set SATus vals stats dt controller

...
function compare_to_dreal(state_vars::Array{Symbol}, control_vars::Array{Symbol}, input_set::Dict, controller_file::String, dynamics_map::Dict, dt::T where T<:Real, output_constraints::Array{Expr}, dirname::String, experiment_name::String, N_steps::T where T<:Real; jobs=1)
    """
    ...
    for t = 0:N_steps-1
        ...
        result = add_output_constraints_and_check_property(formula, output_constraints, state_vars, t+1; jobs=jobs)

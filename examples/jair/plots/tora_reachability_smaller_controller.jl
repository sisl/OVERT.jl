...
JLD2.@load "examples/jair/data/tora_reachability_smaller_controller_data.jld2"
...
PGFPlots.save("examples/jair/plots/tora_reachability_smaller_controller_data.tex", fig)

...
JLD2.@load "examples/jair/data/tora_reachability_smallest_controller_data.jld2"
...
fig = plot_output_sets_pgfplot(all_sets[6:6:24]; idx=idx, fig=fig, linewidth="thick",

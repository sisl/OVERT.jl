...
function tora_dynamics(range_dict, N_overt)
    v2 = :(0.1*sin(x3) - x1)
...
control_vars = [:c1]
dynamics, update_rule = tora_dynamics, tora_update_rule
network_file = "/home/amaleki/Dropbox/stanford/Python/OverApprox/MIP_stuff/controller_simple_tora.nnet"

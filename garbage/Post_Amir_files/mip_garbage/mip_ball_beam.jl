...
N_OVERT = 10
n_timesteps = 10
input_set_0 = Hyperrectangle(low = [0.5, 0.5, 0.5, 0.5], high = [1.5, 1.5, 1.5, 1.5])
input_vars = [:x1, :x2, :x3, :x4]
control_vars = [:c1]
dynamics = ball_beam_dynamics_overt
update_rule  = ball_beam_update_rule
#network_file = "/home/amaleki/Dropbox/stanford/Python/OverApprox/MIP_stuff/nnet_files/controller_simple_ball_beam.nnet"
network_file = "/home/amaleki/Dropbox/stanford/Python/OverApprox/MIP_stuff/nnet_files/controller_complex_ball_beam.nnet"
...
fig = plot_output_sets(out_sets_simulated, fig=fig, linecolor=:red, linestyle=:dash, linewidth=2)
